...
<center>
  <div class="container">
    <div class="cabecalho">
      <p class="informacao">18/08/2021</p>
      <h1 class="titulo">Veja todos os mapas gerados pelo Projeto GeoCovid ES</h1>
      <p class="texto">Veja os Mapas de Casos Diários de Covid-19, Timelapse da Taxa de infecção da Covid-19 e Óbitos de Covid-19 entre 01/04/2020 e 31/06/2021 no Espírito Santo.</p>
      <br>
      ...
      <div class="share">
        ...
        <br><br>
        <center>
          <img class="foto" src="https://bn1304files.storage.live.com/y4m2Bw0k0vrWfp9RNI4v6xYXYcGLl5RvugsDdiie56UPdOjwv8s1xM0V5eduGjFQvlizPVqrIczrZ9-P5MeG66uGKcIOZ6nmGBdZz7rW3Sph8IpCVZybXhFjkYNXBKdGiJVyBelQqkZ73cvaYwjrx1H_m0Js5v0Cax4PxxoE1GPQ9A44cVTfSPRy1vFVae2jV5L?width=1884&height=1550&cropmode=none" alt="Imagem de capa">
        </center>
      </div>
      <div class="corpo">
        <p class="texto">Os vídeos têm o objetivo de relatar a abstração da dinâmica dos casos e fornecer um panorama do agravamento da doença relacionada ao tempo. A análise das retrospectivas geradas, nos possibilitam observar, de modo em geral, os picos de agravamento dos casos entre os municípios do estado do Espírito Santo.
        <br><br>
        <div class="instagram-frame">
          <p>Timelapse dos Casos Diários de Covid-19 no Espírito Santo entre os dias 01/03/2020 a 31/06/2021:</p>
          <iframe class="frame" width="720" height="720" src="https://www.youtube.com/embed/sodia-dn3pw/embed" frameborder="0"></iframe>
        </div>
        <div class="instagram-frame">
          <p>Timelapse da Taxa de infecção da Covid-19 no Espírito Santo entre os dias 01/04/2020 a 31/06/2021:</p>
          <iframe class="frame" width="720" height="720" src="https://www.youtube.com/embed/80JlcYfJdx0/embed" frameborder="0"></iframe>
        </div>
        <div class="instagram-frame">
          <p>Timelapse dos Óbitos de Covid-19 no Espírito Santo entre os dias 01/04/2020 a 31/06/2021:</p>
          <iframe class="frame" width="720" height="720" src="https://www.youtube.com/embed/MY-0dVrmnZw/embed" frameborder="0"></iframe>
        </div>
        <p class="texto">Tenha acesso a todos os Mapas e Dados em nossa página <a class="links" href="/data" target="_blank"><b style="color: #181B34;">Dados gerados.</b></a></p>
        <br><br>
